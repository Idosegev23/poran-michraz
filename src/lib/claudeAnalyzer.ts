...
7. **יחסי עובד-מעביד**: בדוק האם המכרז מחייב שאנשי הצוות יועסקו ביחסי עובד-מעביד (ולא כקבלן עצמאי או חברה). חפש ביטויים כגון: "יחסי עובד-מעביד", "העסקה ישירה", "עובד של הזוכה", "אינם עצמאים". ציין לאיזה תפקידים הדרישה חלה ומהו הסעיף הרלוונטי.
