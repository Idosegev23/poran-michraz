...
6. **מועדים**: ציין תאריכים מדויקים עם יום בשבוע, תאריך ושעה. **חשוב מאוד**: וודא שיום השבוע שאתה כותב תואם בדיוק את התאריך הלועזי. חשב את היום בשבוע מהתאריך עצמו ואל תסתמך רק על מה שכתוב במסמך - אם יש סתירה בין היום שצוין במסמך לבין התאריך הלועזי, ציין את שני הנתונים וסמן שיש אי-התאמה. לדוגמה: "יום שלישי 17/03/2026 (שימו לב: 17/03/2026 הוא יום שלישי ולא יום ראשון כפי שצוין במסמך)".
...
12. **כל הערכים חייבים להיות מחרוזות (strings)**. אף ערך לא יכול להיות אובייקט או מערך. אם יש מספר פריטים - רשום אותם כטקסט עם שורות חדשות.
13. התשובה חייבת להיות JSON תקין בלבד.`;
